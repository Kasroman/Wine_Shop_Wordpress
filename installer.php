...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Roman_Cyber34_wineetvin_91fa728b3162de214316_20220314180959_archive.zip';
	const ARCHIVE_SIZE		 = '47481712';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '91fa728-14180959';
    const SECONDARY_PACKAGE_HASH = '2546398-14180959';
	const VERSION			 = '1.4.4';
